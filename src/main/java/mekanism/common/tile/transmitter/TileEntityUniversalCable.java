...
import dev.ic2universalenergy.integration.ic2.UniversalCableIc2EnergyAdapter;
import dev.ic2universalenergy.integration.ic2.EnergyDemandGate;
...
public class TileEntityUniversalCable extends TileEntityTransmitter implements IComputerTile, IEnergySink {

    private final EnergyHandlerManager energyHandlerManager;
    private final EnergyDemandGate ic2EnergyDemandGate = new EnergyDemandGate();
    private boolean ic2EnergyNetRegistered;
    ...
    public EnergyDemandGate getIc2EnergyDemandGate() {
        return ic2EnergyDemandGate;
    }

    @Override
    public void onAdded() {
        super.onAdded();
        registerWithIc2EnergyNet();
    }
    ...
    private void registerWithIc2EnergyNet() {
        if (!ic2EnergyNetRegistered) {
            ic2EnergyNetRegistered = UniversalCableIc2EnergyAdapter.register(this);
        }
    }

    private void unregisterFromIc2EnergyNet() {
        if (ic2EnergyNetRegistered) {
            UniversalCableIc2EnergyAdapter.unregister(this);
            ic2EnergyNetRegistered = false;
        }
    }

    @Override
    public boolean acceptsEnergyFrom(IEnergyEmitter emitter, Direction direction) {
        return UniversalCableIc2EnergyAdapter.acceptsEnergyFrom(this, direction);
    }

    @Override
    public double getDemandedEnergy() {
        return UniversalCableIc2EnergyAdapter.demandedEnergy(this);
    }
    ...
    public double injectEnergy(Direction directionFrom, double amount, double voltage) {
        return UniversalCableIc2EnergyAdapter.injectEnergy(this, directionFrom, amount);
    }

    @Override
    protected void onUpdateServer() {
        super.onUpdateServer();
        ic2EnergyDemandGate.tickServer(this);
    ...
    public void load(@NotNull CompoundTag nbt) {
        super.load(nbt);
        ic2EnergyDemandGate.load(nbt);
    }

    @Override
    public void saveAdditional(@NotNull CompoundTag nbt) {
        super.saveAdditional(nbt);
        ic2EnergyDemandGate.save(nbt);
    }
