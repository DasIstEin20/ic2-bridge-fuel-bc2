...
@Mod(Ic2UniversalEnergyExtension.MOD_ID)
public final class Ic2UniversalEnergyExtension
{
    public static final String MOD_ID = "ic2universalenergy";
    ...
    private final Mekanism transmitterModule;
    ...
    public Ic2UniversalEnergyExtension(FMLJavaModLoadingContext context)
    {
        ...
        // Bootstrap the literal Mekanism transmitter extraction inside this single
        // Forge mod container before the bridge installs its IC2 EnergyNet adapters.
        this.transmitterModule = new Mekanism();
