    ...
    private void addMiscRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ExtendedShapedRecipeBuilder.shapedRecipe(MekanismItems.CONFIGURATOR)
              .pattern(RecipePattern.createPattern(
                    ...
                    TripleLine.of(Pattern.ALLOY, Pattern.ENERGY, Pattern.ALLOY),
                    TripleLine.of(Pattern.EMPTY, Pattern.CONSTANT, Pattern.EMPTY))
              ).key(Pattern.ENERGY, Ic2RecipeIngredients.item("re_battery"))
              .key(Pattern.ALLOY, Ic2RecipeIngredients.item("alloy"))
              .key(Pattern.INGOT, Ic2RecipeIngredients.item("frequency_transmitter"))
              .key(Pattern.CONSTANT, Ic2RecipeIngredients.item("rubber"))
              .build(consumer);
        //Crafting formula
