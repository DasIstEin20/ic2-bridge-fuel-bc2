...
// Kept in a separate namespace so the destructive chunk unload/reload regression
// tests can be run independently from the energy bridge integration test.
@GameTestHolder(Mekanism.MODID + "_transmitter_tests")
public class TransmitterNetworkTest {

    private static final String BASE_PATH = Mekanism.MODID + ":transmitter/";
